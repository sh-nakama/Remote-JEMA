...
| F1–F5 | Frontend items | P2 | Partial — F5 fixed (`review/2026-09-25`): http(s)-only links at ingest, export and `openUrl`. F2 fixed: create-vite tsconfig layout (nothing emitted) and `--config vite.config.ts` in every script |
